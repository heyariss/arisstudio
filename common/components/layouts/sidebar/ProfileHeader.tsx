      ...
      <div className="relative overflow-hidden hidden w-full pb-2 lg:flex flex-col items-center">
        ...
        <div className="-mt-11 shadow-md border-2 z-10 border-white dark:border-neutral-800 rounded-full">
          <Image
            ...
            className="profile-picture lg:hover:scale-105"
          />
        </div>
      </div>
      <Image
        ...
        height={expandMenu ? 80 : imageSize * 0.9}
        rounded="rounded-full"
        className="profile-picture lg:hover:scale-105 lg:hidden"
      />
      <div className="flex gap-2 items-center mt-1">
        <Link href="/" passHref>
          <h2 className="flex-grow text-lg lg:text-xl font-sora font-medium">Riski Aris Sandy</h2>
        </Link>
